...
public class Vehicle extends Address implements Comparable<Vehicle>{
	...
	public Vehicle(int type, int age, String licensePlate, float weight, String state, String street, int zip, String town) {
	...
	public String toString() {
		return "Vehicle [type=" + type + ", age=" + age + ", licensePlate=" + licensePlate + ", weight=" + weight
				+ "]";
	}
